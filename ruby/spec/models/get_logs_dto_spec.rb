...
# Unit tests for Composio::GetLogsDTO
describe Composio::GetLogsDTO do
  let(:instance) { Composio::GetLogsDTO.new }

  describe 'test an instance of GetLogsDTO' do
    it 'should create an instance of GetLogsDTO' do
      expect(instance).to be_instance_of(Composio::GetLogsDTO)
    end
  end
