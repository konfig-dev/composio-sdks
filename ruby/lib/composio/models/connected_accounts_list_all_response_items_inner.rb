...
module Composio
  class ConnectedAccountsListAllResponseItemsInner
    ...
    def self.openapi_types
      {
        :'connector_id' => :'String',
        :'connection_params' => :'ConnectedAccountsListAllResponseItemsInnerConnectionParams',
        :'id' => :'String',
        :'status' => :'Status',
        :'created_at' => :'String',
        :'updated_at' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Composio::ConnectedAccountsListAllResponseItemsInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Composio::ConnectedAccountsListAllResponseItemsInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [connector_id, connection_params, id, status, created_at, updated_at, app_name, logo].hash
    end
