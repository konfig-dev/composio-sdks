...
module Composio
  class TeamApi
    ...
    # @param id [String] 
    # @param [Hash] extra additional parameters to pass along through :header_params, :query_params, or parameter name
    def remove_member_by_id(id:, extra: {})
      remove_member_by_id_with_http_info_impl(id, extra)
      nil
    end
    ...
    # @param id [String] 
    # @param [Hash] extra additional parameters to pass along through :header_params, :query_params, or parameter name
    def remove_member_by_id_with_http_info(id:, extra: {})
      remove_member_by_id_with_http_info_impl(id, extra)
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    private def remove_member_by_id_impl(id, opts = {})
      remove_member_by_id_with_http_info(id, opts)
      nil
    end
    ...
    private def remove_member_by_id_with_http_info_impl(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TeamApi.remove_member_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TeamApi.remove_member_by_id"
      end
      pattern = Regexp.new(/[^\\/#\?]+?/)
      if @api_client.config.client_side_validation && id !~ pattern
        fail ArgumentError, "invalid value for 'id' when calling TeamApi.remove_member_by_id, must conform to the pattern #{pattern}."
      end
      ...
      new_options = opts.merge(
        :operation => :"TeamApi.remove_member_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TeamApi#remove_member_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      APIResponse::new(data, status_code, headers, response)
    end
