...
module Composio
  class IntegrationsGetIntegrationDetailsResponse
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'String',
        :'auth_scheme' => :'String',
        :'auth_config' => :'IntegrationsGetIntegrationDetailsResponseAuthConfig',
        :'created_at' => :'String',
        :'updated_at' => :'String',
        :'enabled' => :'Boolean',
        :'app_id' => :'String',
        :'expected_input_fields' => :'Array<Object>',
        :'logo' => :'String',
        :'app_name' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Composio::IntegrationsGetIntegrationDetailsResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Composio::IntegrationsGetIntegrationDetailsResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, name, auth_scheme, auth_config, created_at, updated_at, enabled, app_id, expected_input_fields, logo, app_name].hash
    end
